...
internal actual object ChurNative {
    ...
    ): Int = ChurJni.runtimeOpen(root, outRuntime)
    ...
    ): Int = ChurJni.vaultPresent(runtime, outPresent)
    ...
    ): Int = ChurJni.vaultCreateBegin(runtime, password, memoryKib, iterations, parallelism, outCreation)

    actual fun vaultCreationAddRecoverySlot(
        creation: Long,
        destination: ChurBuffer,
        outWritten: IntArray,
    ): Int = ChurJni.vaultCreationAddRecoverySlot(creation, destination.buffer, outWritten)

    actual fun vaultCreationActivate(
        creation: Long,
        outSession: LongArray,
    ): Int = ChurJni.vaultCreationActivate(creation, outSession)
    ...
    actual fun vaultUnlock(
        ...
        secret: ByteArray,
        outSession: LongArray,
    ): Int = ChurJni.vaultUnlock(runtime, factor, secret, outSession)

    actual fun vaultLock(
        session: Long,
        reason: Int,
    ): Int = ChurJni.vaultLock(session, reason)
    ...
    actual fun sharingPrepareDevice(
        ...
        ChurJni.sharingPrepareDevice(
            session,
            collectionId,
            recipientEvidence.buffer,
            recipientEvidenceLength,
            recipientDeviceId,
            permissions,
            fingerprintVerified,
            destination.buffer,
    ...
    actual fun sharingRevoke(
        ...
        destination: ChurBuffer,
        outWritten: IntArray,
    ): Int = ChurJni.sharingRevoke(session, collectionId, recipientVaultId, recipientDeviceId, acceptedAtMs, destination.buffer, outWritten)
    ...
    actual fun syncStage(
        ...
        record: ChurBuffer,
        length: Int,
    ): Int = ChurJni.syncStage(runtime, vaultId, kind, stagedAtMs, record.buffer, length)
    ...
    actual fun catalogQuery(
        ...
        destination: ChurBuffer,
        outWritten: IntArray,
    ): Int = ChurJni.catalogQuery(session, scope, sort, kinds, limit, scopeId, cursor, terms, destination.buffer, outWritten)
    ...
    actual fun exportBegin(
        ...
        destinationFd: Int,
        outExport: LongArray,
    ): Int = ChurJni.exportBegin(session, objectId, destinationFd, outExport)

    actual fun backupCreate(
        session: Long,
        destinationFd: Int,
        outOperation: LongArray,
    ): Int = ChurJni.backupCreate(session, destinationFd, outOperation)
    ...
    actual fun backupRestore(
        ...
        password: ByteArray,
        outOperation: LongArray,
    ): Int = ChurJni.backupRestore(runtime, sourceFd, password, outOperation)

    actual fun integrityScanBegin(
        session: Long,
        objectId: ByteArray?,
        outScan: LongArray,
    ): Int = ChurJni.integrityScanBegin(session, objectId, outScan)
    ...
    ): Int = ChurJni.operationPoll(operation, outCounts, outStates, outObjectId)
    ...
    actual fun objectReaderOpen(
        ...
        streamKind: Int,
        outReader: LongArray,
    ): Int = ChurJni.objectReaderOpen(session, objectId, streamKind, outReader)

    actual fun objectReaderSize(
        reader: Long,
        outSize: LongArray,
    ): Int = ChurJni.objectReaderSize(reader, outSize)

    actual fun objectReaderContentInfo(
        reader: Long,
        outNumbers: LongArray,
        outContentType: ByteArray,
    ): Int = ChurJni.objectReaderContentInfo(reader, outNumbers, outContentType)
    ...
    actual fun objectReaderVerifyComplete(
        reader: Long,
        outState: IntArray,
    ): Int = ChurJni.objectReaderVerifyComplete(reader, outState)
    ...
    actual fun vaultAddDeviceSlot(
        ...
        itemId: ByteArray,
        outSecret: ByteArray,
    ): Int = ChurJni.vaultAddDeviceSlot(session, itemId, outSecret)

    actual fun vaultRemoveSlot(
        session: Long,
        slotId: ByteArray,
    ): Int = ChurJni.vaultRemoveSlot(session, slotId)

    actual fun vaultChangePassword(
        session: Long,
        password: ByteArray,
    ): Int = ChurJni.vaultChangePassword(session, password)
    ...
    actual fun vaultKeystoreBegin(
        ...
        destination: ChurBuffer,
        outWritten: IntArray,
    ): Int = ChurJni.vaultKeystoreBegin(session, destination.buffer, outWritten)

    actual fun vaultKeystoreCommit(
        session: Long,
        gcmNonce: ByteArray,
        wrappedRootSecret: ByteArray,
    ): Int = ChurJni.vaultKeystoreCommit(session, gcmNonce, wrappedRootSecret)

    actual fun vaultKeystoreMaterial(
        runtime: Long,
        destination: ChurBuffer,
        outWritten: IntArray,
    ): Int = ChurJni.vaultKeystoreMaterial(runtime, destination.buffer, outWritten)
    ...
    actual fun objectMetadata(
        ...
        destination: ChurBuffer,
        outWritten: IntArray,
    ): Int = ChurJni.objectMetadata(session, objectId, destination.buffer, outWritten)
    ...
    actual fun albumList(
        ...
        destination: ChurBuffer,
        outWritten: IntArray,
    ): Int = ChurJni.albumList(session, destination.buffer, outWritten)
    ...
    actual fun derivedPut(
        ...
        source: ChurBuffer,
        length: Int,
    ): Int = ChurJni.derivedPut(session, objectId, kind, width, height, source.buffer, length)
    ...
    actual fun derivedRead(
        ...
        destination: ChurBuffer,
        outWritten: IntArray,
    ): Int = ChurJni.derivedRead(session, objectId, kind, destination.buffer, outWritten)
}

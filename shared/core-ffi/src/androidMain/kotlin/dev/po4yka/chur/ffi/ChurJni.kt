...
internal object ChurJni {
    ...
    external fun vaultPresent(
        runtime: Long,
        outPresent: ByteArray,
    ): Int

    external fun vaultCreateBegin(
        runtime: Long,
        password: ByteArray,
        memoryKib: Int,
        iterations: Int,
    ...
    external fun vaultCreationAddRecoverySlot(
        creation: Long,
        destination: ByteBuffer,
        outWritten: IntArray,
    ): Int

    external fun vaultCreationActivate(
        creation: Long,
    ...
    external fun sharingPrepareDevice(
        session: Long,
        collectionId: ByteArray,
        recipientEvidence: ByteBuffer,
    ...
    external fun backupCreate(
        session: Long,
        destinationFd: Int,
        outOperation: LongArray,
    ): Int

    external fun backupRestore(
        runtime: Long,
        sourceFd: Int,
        password: ByteArray,
        outOperation: LongArray,
    ...
    external fun integrityScanBegin(
        session: Long,
        objectId: ByteArray?,
        outScan: LongArray,
    ): Int

    external fun operationPoll(
        operation: Long,
        outCounts: LongArray,
        outStates: IntArray,
    ...
    external fun objectReaderSize(
        reader: Long,
        outSize: LongArray,
    ): Int

    external fun objectReaderContentInfo(
        reader: Long,
        outNumbers: LongArray,
        outContentType: ByteArray,
    ): Int

    external fun objectReaderReadAt(
        reader: Long,
        offset: Long,
        destination: ByteBuffer,
        outWritten: IntArray,
    ...
    external fun objectReaderVerifyComplete(
        reader: Long,
        outState: IntArray,
    ): Int
    ...
    external fun vaultAddRecoverySlot(
        session: Long,
        destination: ByteBuffer,
        outWritten: IntArray,
    ): Int
    ...
    external fun vaultRemoveSlot(
        session: Long,
        slotId: ByteArray,
    ): Int

    external fun vaultChangePassword(
        session: Long,
        password: ByteArray,
    ): Int

    external fun vaultSlots(
        session: Long,
        destination: ByteBuffer,
        outWritten: IntArray,
    ): Int
    ...
    external fun vaultKeystoreCommit(
        session: Long,
        gcmNonce: ByteArray,
        wrappedRootSecret: ByteArray,
    ): Int

    external fun vaultKeystoreMaterial(
        runtime: Long,
        destination: ByteBuffer,
        outWritten: IntArray,
    ): Int

    external fun objectSetFavorite(
        session: Long,
        objectId: ByteArray,
        favorite: Boolean,
    ): Int

...
internal expect object ChurNative {
    ...
    fun vaultCreationAddRecoverySlot(
        creation: Long,
        destination: ChurBuffer,
        outWritten: IntArray,
    ): Int

    fun vaultCreationActivate(
        creation: Long,
    ...
    fun objectReaderSize(
        reader: Long,
        outSize: LongArray,
    ): Int

    fun objectReaderContentInfo(
        reader: Long,
    ...
    fun objectReaderVerifyComplete(
        reader: Long,
        outState: IntArray,
    ): Int
    ...
    fun vaultKeystoreCommit(
        session: Long,
        gcmNonce: ByteArray,
        wrappedRootSecret: ByteArray,
    ): Int

    fun vaultKeystoreMaterial(
        runtime: Long,
        destination: ChurBuffer,
        outWritten: IntArray,
    ): Int

    fun objectSetFavorite(
        session: Long,
        objectId: ByteArray,
        favorite: Boolean,
    ): Int

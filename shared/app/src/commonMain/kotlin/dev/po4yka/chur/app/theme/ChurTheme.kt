...
fun ChurTheme(
    ...
    val scheme = (if (dark) darkColorScheme() else lightColorScheme()).copy(
        ...
        // FABs use primaryContainer rather than primary.
        primaryContainer = colors.ink,
        onPrimaryContainer = colors.onInk,
        inversePrimary = if (dark) ChurLightColors.accent else ChurDarkColors.accent,
        secondary = colors.accent,
        onSecondary = colors.onInk,
        secondaryContainer = colors.accentSoft,
        onSecondaryContainer = colors.ink,
        tertiary = colors.inkMuted,
        ...
        errorContainer = colors.surfaceSubtle,
        ...
        secondaryFixed = ChurLightColors.accentSoft,
        secondaryFixedDim = ChurDarkColors.accent,
        onSecondaryFixed = ChurLightColors.ink,
        onSecondaryFixedVariant = ChurLightColors.ink,
        tertiaryFixed = ChurLightColors.surfaceSubtle,
        tertiaryFixedDim = ChurLightColors.surfaceSunken,

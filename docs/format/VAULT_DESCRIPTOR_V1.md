...
```text
offset  size  field                          v1 value
0x00     2    catalog_format_version:u16     0x0001 through 0x0006
...
- only `descriptor_version` `0x0001`, `canonical_encoding_profile` `0x0001`, `crypto_policy_id` `0x0001`, catalog format version `0x0001` through `0x0006`, `catalog_crypto_suite` `0x0001`, `object_store_format_version` `0x0001`, `naming_profile_id` `0x0001`, and `slot_version` `0x0001` are accepted;
